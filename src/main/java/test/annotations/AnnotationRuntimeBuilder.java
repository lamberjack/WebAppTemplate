...
public final class AnnotationRuntimeBuilder {
    ...
    private static final Method Atomic_casAnnotationData = null;
    ...
    public static <T extends Annotation> void putAnnotationOnMethod(Class<?> c, Class<T> annotationClass, T annotation, Method m) {
        try {
            while (true) { // retry loop
                int classRedefinedCount = Class_classRedefinedCount.getInt(c);
                Object /*AnnotationData*/ annotationData = Class_annotationData.invoke(c);
